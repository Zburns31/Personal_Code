...
def retrieve_stock_data(ticker):
    ...
    lhs_stock_table, rhs_stock_table = get_data_table(
    ...
    income_statement_data, table_headers = get_financial_statements_data(
        income_statement_bs_obj, 'income_statement')
